...
import com.example.roadradar.models.NewData;
import com.example.roadradar.models.Radar;
import com.example.roadradar.models.Vehicle;
...
public class RadarDetectionService {
    ...
    public void loadRadars() {
        ResponseEntity<Radar[]> exchange = restTemplate.exchange("http://localhost:8761/RADAR-SERVICE/api/radar/radars", HttpMethod.GET, null, Radar[].class);
        ResponseEntity<Vehicle[]> exchangeVehicle = restTemplate.exchange("http://localhost:8761/REGISTRATION-SERVICE/api/vehicle/vehicles", HttpMethod.GET, null, Vehicle[].class);
    ...
    public void submitOverSpeedDetection() {
        ...
        this.restTemplate.exchange(
                "http://localhost:8761/RADAR-SERVICE/api/radar/newInfraction",
                HttpMethod.POST,
